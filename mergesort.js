...
var smallArray = [5, 2, 4, 1, 6, 3];
var smallArrayBak = [5, 2, 4, 1, 6, 3];
// var smallArray = [5, 2, 4, 1, 6];
...
var mergeSort = (function() {
	var mergeSort = function mergeSort(array, low, high) {
		...
		if (high - low < 2) { // already sorted
			return;
		}

		middle = Math.floor((high - low) / 2) + low;

		console.log('mergeSort', low, middle, high, array);
		mergeSort(array, low, middle);
		mergeSort(array, middle + 1, high);

		console.log('merge', low, middle, high);
		merge(array, low, high, middle);
		
	};

	var merge = function merge(array, low, high, middle) {
		var i = low;
		var j = middle + 1;
		var k = low;
		var output = [];

		console.log(i , middle, j , high);
...
var sortedArray = mergeSort(smallArray);
console.log(smallArrayBak);
